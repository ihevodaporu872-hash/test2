    ...
    <>
      ...
      <main id="main-content" className="min-h-screen">
        ...
        <CTASection
          ...
          description="Посмотрите наши пакеты с прозрачными ценами и понятными условиями. Чертежи для строителей — 80-150 листов, авторский надзор — совпадение с проектом 95%+."
