...
export const metadata: Metadata = {
  ...
  description:
    "Дизайн-решения для застройщиков и управляющих компаний: МОП, паркинги, планировочный аудит. Повышаем стоимость вашего объекта.",
  openGraph: {
    title: "Дизайн для бизнеса | Interior Studio",
    description:
      "Дизайн-решения для застройщиков и управляющих компаний.",
